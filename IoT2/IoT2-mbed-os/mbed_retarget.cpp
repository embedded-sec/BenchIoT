...
#if defined(__ARMCC_VERSION)  && (!defined(CLANG_PATCH_ENABLED))
...
#if defined(__MICROLIB) && (__ARMCC_VERSION>5030000)  && (!defined(CLANG_PATCH_ENABLED))
...
#elif defined(TOOLCHAIN_GCC) || (defined(CLANG_PATCH_ENABLED))
    posix &= ~O_BINARY;
#endif
    return posix;
}
...
#if defined (__ARMCC_VERSION) && (__ARMCC_VERSION >= 6010050) && (!defined(CLANG_PATCH_ENABLED))
...
#if defined(TOOLCHAIN_GCC) || (defined(CLANG_PATCH_ENABLED))
...
#if defined(TOOLCHAIN_GCC_ARM) || defined(TOOLCHAIN_GCC_CR) || (defined(CLANG_PATCH_ENABLED))
...
#if defined(TOOLCHAIN_ARM) || defined(TOOLCHAIN_GCC) || (defined(CLANG_PATCH_ENABLED))
...
#endif
#elif defined(__CC_ARM) && (!defined(CLANG_PATCH_ENABLED))
// Do nothing
#elif defined (__GNUC__) || (defined(CLANG_PATCH_ENABLED))
struct _reent;
// Stub out locks when an rtos is not present
