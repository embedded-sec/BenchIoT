...
__attribute__((naked)) void /*uint16_t*/ thumb2_checksum(const void* pData, int length)
{
    __asm (
        ...
        "beq thumb2_checksum_label_1\n"
        // We can return if there are no bytes to sum.
        "cbz r1, thumb2_checksum_label_9\n"
        ...
        "thumb2_checksum_label_1:\n"
        "ands r4, r0, #3\n"
        "beq thumb2_checksum_label_2\n"
        // Have more than 1 byte left to align?  If not skip ahead to take care of
        // trailing byte.
        "cmp r1, #2\n"
        "blt thumb2_checksum_label_7\n"
        ...
        "thumb2_checksum_label_2:\n"
        "cmp r1, #8\n"
        "blt thumb2_checksum_label_3\n"
        ...
        "adc  r2, r2, #0\n"
        "subs r1, r1, #8\n"
        "b thumb2_checksum_label_2\n"

        // Sum up any remaining half-words.
        "thumb2_checksum_label_3:\n"
        ...
        "adc r2, r2, #0\n"
        "subs r1, r1, #2\n"
        "b thumb2_checksum_label_3\n"

        // Handle trailing byte, if it exists
        "thumb2_checksum_label_7:\n"
        "cbz r1, thumb2_checksum_label_8\n"
        "ldrb r4, [r0]\n"
        "adds r2, r4\n"
        "adc r2, r2, #0\n"

        // Fold 32-bit checksum into 16-bit checksum.
        "thumb2_checksum_label_8:\n"
        "ubfx r4, r2, #16, #16\n"
        "ubfx r2, r2, #0, #16\n"
        "adds r2, r4\n"
        "ubfx r4, r2, #16, #16\n"
        ...
        "cbz r3, thumb2_checksum_label_9\n"
        "rev16 r2, r2\n"

        // Return final sum.
        "thumb2_checksum_label_9:\n"
        "mov r0, r2\n"
        "pop {r4, pc}\n"
    );
}
