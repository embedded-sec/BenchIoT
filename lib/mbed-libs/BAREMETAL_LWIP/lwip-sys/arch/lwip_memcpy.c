...
__attribute__((naked)) void thumb2_memcpy(void* pDest, const void* pSource, size_t length)
{
    __asm (
        ...
        "lsrs r3, r2, #4\n"
        "beq.n thumb2_memcpy_label_2\n"
        "thumb2_memcpy_label_1:\n"
        "ldr r12, [r1], #4\n"
        "str r12, [r0], #4\n"
        "ldr r12, [r1], #4\n"
        "str r12, [r0], #4\n"
        ...
        "str r12, [r0], #4\n"
        "subs r3, #1\n"
        "bne  thumb2_memcpy_label_1\n"

        // Copy byte by byte for what is left.
        "thumb2_memcpy_label_2:\n"
        "ands r3, r2, #0xf\n"
        "beq.n thumb2_memcpy_label_4\n"
        "thumb2_memcpy_label_3:\n"
        "ldrb r12, [r1], #1\n"
        "strb r12, [r0], #1\n"
        "subs r3, #1\n"
        "bne  thumb2_memcpy_label_3\n"

        // Return to caller.
        "thumb2_memcpy_label_4:\n"
        "bx lr\n"
    );
}
