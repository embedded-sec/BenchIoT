...
# board. This file is board specific and is added in the Benchmark.mk
# file. If such files are added here make sure that only one is linked
# per board to avoid compilation errors.
#
################################################################################
...
DISPLAY_LIB_DIR = $(DISPLAY_LIB_ROOT)display_template
