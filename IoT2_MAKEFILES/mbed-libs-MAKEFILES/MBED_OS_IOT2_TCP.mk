...
# Folder of iot2TCP
MBED_OS_IOT2_TCP_LIB_DIR = $(PROJDIR)IoT2/IoT2-mbed-wrappers/IoT2_wrappers/tcp/mbed-os
...
MBED_OS_IOT2_TCP_LIB_C_SRCS = $(foreach dir,$(MBED_OS_IOT2_TCP_LIB_DIR),$(wildcard $(dir)/*.c))
MBED_OS_IOT2_TCP_LIB_CXX_SRCS = $(foreach dir,$(MBED_OS_IOT2_TCP_LIB_DIR),$(wildcard $(dir)/*.cpp))


# add result_collection lib to mbed lib dirs
MBED_LIBS_DIRS += $(MBED_OS_IOT2_TCP_LIB_DIR)

# Add the library to the global mbed libs srcs
MBED_LIBS_C_SRCS += $(MBED_OS_IOT2_TCP_LIB_C_SRCS)
MBED_LIBS_CXX_SRCS += $(MBED_OS_IOT2_TCP_LIB_CXX_SRCS)
