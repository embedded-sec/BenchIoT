...
# Folder of iot2TCP
IOT2FS_SDIO_INTERFACE_DIR = $(PROJDIR)/IoT2/IoT2-mbed-wrappers/IoT2_wrappers/sdio
...
IOT2FS_SDIO_INTERFACE_C_SRCS = $(foreach dir,$(IOT2FS_SDIO_INTERFACE_DIR),$(wildcard $(dir)/*.c))
IOT2FS_SDIO_INTERFACE_CXX_SRCS = $(foreach dir,$(IOT2FS_SDIO_INTERFACE_DIR),$(wildcard $(dir)/*.cpp))


# add result_collection lib to mbed lib dirs
MBED_LIBS_DIRS += $(IOT2FS_SDIO_INTERFACE_DIR)

# Add the library to the global mbed libs srcs
MBED_LIBS_C_SRCS += $(IOT2FS_SDIO_INTERFACE_C_SRCS)
MBED_LIBS_CXX_SRCS += $(IOT2FS_SDIO_INTERFACE_CXX_SRCS)
