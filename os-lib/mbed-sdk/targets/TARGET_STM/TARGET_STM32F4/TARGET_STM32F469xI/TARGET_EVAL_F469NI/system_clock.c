...
/**
  * ============================================================================
  *
  * This file has been configured using STM RCC clock configuration example
  * and adopts the mbed style to configure the system clock used for 
  * DISCO_F469NI.
  * 
  * ============================================================================
**/
...
uint8_t SetSysClock_PLL_HSE(uint8_t bypass)
{
    ...
    RCC_OscInitStruct.PLL.PLLR = 6;             // [iot2-debug]: This value is setup tp 6 at the
                                                // initial clock configuration. Double check!!
                                                // 4/30/18: changed from 2 to 6
    ...
    PeriphClkInitStruct.PLLSAI.PLLSAIN = 384; //[iot2-debug]: Revise!!
    PeriphClkInitStruct.PLLSAI.PLLSAIQ = 7;   //[iot2-debug]: Revise!!
...
uint8_t SetSysClock_PLL_HSI(void)
{
    ...
    RCC_OscInitStruct.PLL.PLLN            = 320;           // VCO output clock = 320 MHz (1 MHz * 320)
    RCC_OscInitStruct.PLL.PLLP            = RCC_PLLP_DIV2; // PLLCLK = 180 MHz (360 MHz / 2)
    RCC_OscInitStruct.PLL.PLLQ            = 7;             //
    RCC_OscInitStruct.PLL.PLLR            = 2;             // [iot2-debug]: This value is setup tp
                                                           // 6 at the// initial clock
