...
//extern void iot2RecordPrivThread(void);
...
__attribute__((always_inline)) __STATIC_INLINE void __set_CONTROL(uint32_t control)
{
  ...
  PrivThreadStatus = control;
  __ASM volatile (
    "push {lr}\n"
    "bl iot2RecordPrivThread\n"
    "pop {lr}\n"
    );
...
/** \ingroup  CMSIS_Core_FunctionInterface
  ...
  @{
 */
#ifdef COUNT_SYSCALLS
extern volatile uint32_t __count_enable_irq;
extern volatile uint32_t __count_disable_irq;
extern volatile uint32_t __count_get_CONTROL;
extern volatile uint32_t __count_set_CONTROL;
extern volatile uint32_t __count_get_IPSR;
extern volatile uint32_t __count_get_APSR;
extern volatile uint32_t __count_get_xPSR;
extern volatile uint32_t __count_get_PSP;
extern volatile uint32_t __count_set_PSP;
extern volatile uint32_t __count_get_MSP;
extern volatile uint32_t __count_set_MSP;
extern volatile uint32_t __count_get_PRIMASK;
extern volatile uint32_t __count_set_PRIMASK;
extern volatile uint32_t __count_enable_fault_irq;
extern volatile uint32_t __count_disable_fault_irq;
extern volatile uint32_t __count_get_BASEPRI;
extern volatile uint32_t __count_set_BASEPRI;
extern volatile uint32_t __count_set_BASEPRI_MAX;
extern volatile uint32_t __count_get_FAULTMASK;
extern volatile uint32_t __count_set_FAULTMASK;
#endif
...
__attribute__((always_inline)) __STATIC_INLINE void __enable_irq(void)
{
      ...
      __count_enable_irq++;
    #endif
    if (__get_IPSR() || !(__get_CONTROL() & 0x1)) /* Privileged code */
    {
...
__attribute__((always_inline)) __STATIC_INLINE uint32_t __get_APSR(void)
{
  uint32_t result;
   ...
   if (__get_IPSR() || !(__get_CONTROL() & 0x1)) /* Privileged code */
    ...
    else  /* Unprivileged code */
    {
      uint32_t result;
      __ASM volatile ("mov r0, #11 \n\t"
                    "svc 255  \n\t" 
                    "mov %0,r0":"=r"(result) : : "r0","memory");
