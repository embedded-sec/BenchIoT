...
// to handle the corner case of uvisor
#if (defined(IOT2_UVISOR) && defined (TARGET_EVAL_F469NI))
    __ASM volatile(
        "cpsid i\n"
        "push {lr}\n"
        "bl iot2EndExceptionTrampoline\n"
        "pop {lr}\n"
        "cpsie i\n"
        );

#endif //defined(IOT2_UVISOR) && defined (TARGET_EVAL_F469NI))
}
...
void mbed_default_mac_address(char *mac) {
    ...
    */
    mac[0] = MBED_MAC_ADDR_0;
    mac[1] = MBED_MAC_ADDR_1;
    mac[2] = MBED_MAC_ADDR_2;
    mac[3] = MBED_MAC_ADDR_3;
    mac[4] = MBED_MAC_ADDR_4;
    mac[5] = MBED_MAC_ADDR_5;
